    ...
    def fit(self, X_train, Y_train, X_test=None, Y_test=None,
        ...
        compute_train_error = theano.function(inputs=[index, ],
                                              ...
                                              givens={
                                                  ...
                                                  self.y: train_set_y[index]},  mode=theano.compile.MonitorMode(post_func=self.detect_nan))
            #mode=mode)
...
def eeg_classify(n_epochs=250):
    ...
    model.fit(traindata, targets, validation_frequency=1000)
